var conf = {
    ...
    //    定义DEMO可选项
    demoType: [
        {key: 'default', val: 'baidu.flash.avatarMaker示例'}
    ],
    //    默认可选项的配置
    'default': {
        //    类实例化选项
        pageConf: {
			...
			jsCode:'var info = baidu.g("info");var options = {createOptions:{id: "flashID",url: "images/avatarMaker.swf",width: "630px",height: "360px",container: "content",uploadCallBack:function(){console.log(arguments)}}};var up = new baidu.flash.avatarMaker(options);var t = function (){var d = new Date();return [d.getHours(),d.getMinutes(),d.getSeconds()].join(":")}'
        },
        upload: {
            type: 'button',
            ...
            event: {
                eventName: 'onclick',
                handler: function(){
					up.upload('images/getfileAvatar.php');
				}
            }
        },
        pause: {
